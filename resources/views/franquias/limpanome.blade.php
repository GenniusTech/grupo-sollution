                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-2">Olá, cliente Grupo Sollution!</h1>
                                            <p class="mb-4">Preencha com os seus dados todas às informações e tenha seu nome limpo!</p>
                                        </div>
                                        @if ($errors->any())
                                        ...
                                        <form id="registrer" class="user" method="POST" action="{{ route('vender', ['id' => $id]) }}">
                                            ...
                                            <div class="col-sm-12 col-lg-8 offset-lg-2 row">
                                                ...
                                                <div class="form-group col-sm-12 col-lg-6">
                                                    <input type="text" id="telefoneInput" oninput="mascaraTelefone(this)" maxlength="15" value="{{ old('whatsapp') }}" class="form-control form-control-user" name="whatsapp" placeholder="WhatsApp" required>
                                                </div>
